...
import { ArrowRight, BookOpen, Calendar, CheckCircle, Clock, CreditCard, FileText, Play, User } from 'lucide-react';
      ...
      <div className="flex-1 container px-4 py-8">
        ...
        >
          ...
          <TabsContent value="consultations">
            <h2 className="text-2xl font-semibold mb-4">{t('yourConsultations')}</h2>
                ...
                <Card className="mb-6">
                  <CardContent className="pt-6">
                    <div className="text-center mb-4">
                      ...
                      <h3 className="text-xl font-semibold mb-2">{t('noConsultations')}</h3>
                      <p className="text-muted-foreground mb-4">{t('upgradeForConsultations')}</p>
                      <Button className="bg-astral-gold hover:bg-astral-gold/90 text-astral-dark">
                        {t('upgradeToPremium')}
                      </Button>
                    </div>
