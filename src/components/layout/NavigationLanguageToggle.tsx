...
interface NavigationLanguageToggleProps {
  isMobile?: boolean;
}

/**
 * Language toggle component for navigation.
 * Part of the layout/navigation atoms in Atomic Design.
 */
const NavigationLanguageToggle = ({ isMobile = false }: NavigationLanguageToggleProps) => {
...
export default NavigationLanguageToggle;
